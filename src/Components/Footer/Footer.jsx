...
import { Container, ContainerItem, Select, Subtext, Title, BottomBox, A, Card, Img, Bottomtitle, FooterBotBox, FootBoxItem, Text, IconConatoner, IconItem, P1, P2 } from './style'
